 ...
 */
final class Version20230112114924 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE vehicle (id INT AUTO_INCREMENT NOT NULL, film_id INT DEFAULT NULL, mileage INT DEFAULT NULL, fuel VARCHAR(255) DEFAULT NULL, category VARCHAR(255) DEFAULT NULL, general_condition VARCHAR(255) DEFAULT NULL, transmition VARCHAR(255) DEFAULT NULL, nb_place INT DEFAULT NULL, availability TINYINT(1) DEFAULT NULL, location VARCHAR(255) DEFAULT NULL, consumption INT DEFAULT NULL, emissions INT DEFAULT NULL, gps TINYINT(1) DEFAULT NULL, air_conditioning TINYINT(1) DEFAULT NULL, description LONGTEXT DEFAULT NULL, title VARCHAR(255) DEFAULT NULL, license VARCHAR(255) DEFAULT NULL, picture VARCHAR(255) DEFAULT NULL, quote VARCHAR(255) DEFAULT NULL, INDEX IDX_1B80E486567F5183 (film_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
